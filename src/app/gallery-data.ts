...
export const galleryAlbums: GalleryAlbum[] = [
    ...
    },
    {
      ...
      folder: 'parkville',
      summary: 'Full sympathetic refurbishment of this period Edwardian property, including a 7m x 6m extension built in the same style, incorporating a period-style bay window with solid wood sash windows.',
      images: albumImages('parkville', [
        '1.jpeg',
        '2.jpeg',
        '3.jpeg',
        '4.jpeg',
...
function albumImages(folder: string, fileNames: string[]): GalleryImage[] {
